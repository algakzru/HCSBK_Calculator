...
//        etDogovornayaSumma.setText(sharedPref.getString(getString(R.string.dogovornaya_summa), ""));
...
//        etSummaVashihVznosov.setText(sharedPref.getString(getString(R.string.summa_vashih_vznosov), ""));
...
//        etDataZakritiya.setText(sharedPref.getString(getString(R.string.data_zakritiya), ""));
        etDataZakritiya.setHint(sdf.format(calendar.getTime()));
